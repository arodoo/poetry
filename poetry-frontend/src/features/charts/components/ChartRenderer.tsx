...
export function ChartRenderer({
  ...
  switch (chartId) {
    case 'usersByStatus':
      return <UsersByStatusChart data={data.usersByStatus} />
    case 'birthdaysThisMonth':
      return <BirthdaysThisMonthChart data={data.birthdaysThisMonth} />
    case 'activeHours':
      return <MostActiveHoursChart data={data.activeHours} />
    case 'populatedRegions':
      return <MostPopulatedRegionsChart data={data.populatedRegions} />
    case 'enrollmentsOverTime':
      return <FingerprintsOverTimeChart data={data.enrollmentsOverTime} />
    case 'membershipsByStatus':
      return <MembershipsByStatusChart data={data.membershipsByStatus} />
    case 'eventsByType':
      return <EventsByTypeChart data={data.eventsByType} />
