/*
 * File: ScheduledEventsByStatusChart.tsx
 * Purpose: Pie chart representing scheduled events grouped by status.
...
export function ScheduledEventsByStatusChart({ data }: { data: Record<string, number> | undefined }): ReactElement | null {
  const t = useT();
  ...
  return (
    <div className="flex h-full flex-col rounded-xl border border-[var(--color-divider)] bg-[var(--color-surface)] p-4 shadow-sm">
      ...
      <div className="mt-4 flex justify-end">
        <Button variant="secondary" size="sm" onClick={() => { void navigate(`/${locale ?? 'en'}/charts/details/scheduledEventsByStatus`); }}>
