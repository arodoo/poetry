...
export function ActiveHoursDetailsView({ data }: ActiveHoursDetailsViewProps): ReactElement {
    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex border-b border-divider gap-4">
                <button className={tabClass('hour')} onClick={() => { setActiveTab('hour'); }}>
                    By Hour
                </button>
                <button className={tabClass('day')} onClick={() => { setActiveTab('day'); }}>
                    Busiest Days
                </button>
                <button className={tabClass('trend')} onClick={() => { setActiveTab('trend'); }}>
                    7-Day Trend
                </button>
            </div>
