    ...
    >
      {isFullscreen ? (
        ...
        >
          <path
            strokeLinecap="round"
            d="M9 9H4m0 0V4m0 5l5-5M15 9h5m0 0V4m0 5l-5-5M9 15H4m0 0v5m0-5l5 5M15 15h5m0 0v5m0-5l-5 5"
          />
        </svg>
      ) : (
        <svg
        ...
        >
          <path
            strokeLinecap="round"
            d="M4 9V4m0 0h5M4 4l5 5M20 9V4m0 0h-5m5 0l-5 5M4 15v5m0 0h5m-5 0l5-5M20 15v5m0 0h-5m5 0l-5-5"
          />
        </svg>
      )}
    </button>
