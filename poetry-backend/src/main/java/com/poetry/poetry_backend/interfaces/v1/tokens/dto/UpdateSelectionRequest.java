...
public record UpdateSelectionRequest(
        @NotBlank(message = "selection.theme.missing") @Pattern(regexp = "^[a-z0-9]+(?:-[a-z0-9]+)*$", message = "theme.key.invalid") String theme,
        ...
        @NotBlank(message = "selection.shadow.missing") String shadow) {
}
