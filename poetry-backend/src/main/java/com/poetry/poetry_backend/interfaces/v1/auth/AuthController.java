/*
 ...
 Purpose: Versioned v1 REST controller for Auth endpoints using application use cases.
...
public class AuthController {
    ...
    public AuthController(LoginUseCase login, RefreshTokenUseCase refresh, LogoutUseCase logout, RegisterUseCase register){
        this.login = login; this.refresh = refresh; this.logout = logout; this.register = register;
    }
