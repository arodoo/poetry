...
public class ThemeConstants {
  public static final String[] DEFAULT_THEMES = new String[]{
    // Format: key|name|key=hsl(...). Includes semantic tokens (onPrimary/Secondary/Surface)
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(215 32% 17%)," +
    "textMuted=hsl(210 28% 65%),textSubtle=hsl(210 36% 75%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(210 40% 96%)," +
    "textMuted=hsl(215 20% 65%),textSubtle=hsl(215 20% 55%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(165 100% 15%)," +
    "textMuted=hsl(156 50% 45%),textSubtle=hsl(156 40% 60%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(322 69% 27%)," +
    "textMuted=hsl(330 50% 50%),textSubtle=hsl(330 40% 65%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(205 85% 22%)," +
    "textMuted=hsl(199 70% 45%),textSubtle=hsl(199 60% 60%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(32 69% 27%)," +
    "textMuted=hsl(40 60% 50%),textSubtle=hsl(40 50% 65%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(215 32% 17%)," +
    "textMuted=hsl(210 28% 65%),textSubtle=hsl(210 24% 75%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(165 100% 15%)," +
    "textMuted=hsl(150 60% 40%),textSubtle=hsl(150 50% 55%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(266 72% 33%)," +
    "textMuted=hsl(262 50% 55%),textSubtle=hsl(262 40% 70%)",
    ...
    "onPrimary=hsl(0 0% 100%),onSecondary=hsl(0 0% 100%),onSurface=hsl(215 32% 13%)," +
    "textMuted=hsl(215 11% 65%),textSubtle=hsl(215 8% 75%)"
  };
}
