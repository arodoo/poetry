...
public class ThemeConstants {
  public static final String[] DEFAULT_THEMES = new String[]{
    // Format name|key=hsl(...),key=hsl(...)
    "Default|primary=hsl(243 75% 58%),secondary=hsl(215 20% 50%),accent=hsl(38 92% 54%)," +
    ...
    "Dark|primary=hsl(239 84% 67%),secondary=hsl(215 28% 28%),accent=hsl(38 92% 54%)," +
    "info=hsl(217 91% 60%),warning=hsl(38 92% 54%),error=hsl(0 84% 60%)," +
    ...
    "Mint|primary=hsl(158 64% 52%),secondary=hsl(152 76% 40%),accent=hsl(153 47% 56%)," +
    ...
    "Rose|primary=hsl(332 74% 40%),secondary=hsl(332 73% 47%),accent=hsl(330 81% 60%)," +
    ...
    "Ocean|primary=hsl(200 96% 34%),secondary=hsl(199 89% 48%),accent=hsl(199 89% 66%)," +
    ...
    "Amber|primary=hsl(34 65% 37%),secondary=hsl(32 80% 44%),accent=hsl(38 92% 54%)," +
    ...
    "Slate|primary=hsl(215 28% 28%),secondary=hsl(215 20% 50%),accent=hsl(215 14% 65%)," +
    "info=hsl(217 91% 60%),warning=hsl(38 92% 54%),error=hsl(0 72% 51%)," +
    ...
    "Forest|primary=hsl(162 100% 12%),secondary=hsl(163 94% 23%),accent=hsl(158 64% 52%)," +
    ...
    "Purple|primary=hsl(266 72% 45%),secondary=hsl(262 83% 58%),accent=hsl(260 89% 75%)," +
    "info=hsl(239 84% 67%),warning=hsl(38 92% 54%),error=hsl(0 72% 51%)," +
    ...
    "Mono|primary=hsl(215 26% 17%),secondary=hsl(215 19% 27%),accent=hsl(215 13% 34%)," +
