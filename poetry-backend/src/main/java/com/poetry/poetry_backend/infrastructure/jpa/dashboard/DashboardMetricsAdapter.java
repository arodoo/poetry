...
public class DashboardMetricsAdapter implements DashboardMetricsQueryPort {
  ...
  public DashboardMetricsDto getMetrics() {
    return new DashboardMetricsDto(
        fetchCounts("SELECT UPPER(status), COUNT(*) as c FROM users GROUP BY UPPER(status)"),
        ...
        fetchCounts("SELECT UPPER(status), COUNT(*) as c FROM memberships GROUP BY UPPER(status)"),
        ...
        fetchCounts("SELECT UPPER(status), COUNT(*) as c FROM seller_codes GROUP BY UPPER(status)"),
