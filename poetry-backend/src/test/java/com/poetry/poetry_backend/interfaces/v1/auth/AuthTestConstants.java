...
public final class AuthTestConstants {
  ...
  public static final String LOGIN_PASSWORD = "loginpass123";
  ...
  public static final String REGISTER_PASSWORD = "registerpass123";
  ...
  public static final String DUPLICATE_PASSWORD = "duplicatepass123";
  ...
  public static final String REFRESH_PASSWORD = "refreshpass123";
  ...
  public static final String JWT_PASSWORD = "jwtpass123";

  // User for audit tests
  public static final String AUDIT_USERNAME = "audituser";
  public static final String AUDIT_PASSWORD = "auditpass123";
  public static final String AUDIT_EMAIL = "audituser@test.com";

  // Common test values
  public static final String TEST_PASSWORD_SHORT = "x";
