/*
 ...
 Purpose: Tests for RFC 7807 ProblemDetail handler using MockMvc.
...
class GlobalProblemHandlerTest {
    ...
    static class DemoController {
        ...
        @PostMapping void create(@RequestBody Payload p) { throw new IllegalArgumentException("bad"); }
    }

    @Test
    void shouldReturnProblemDetail() throws Exception {
        mvc.perform(post("/test/validation").contentType(MediaType.APPLICATION_JSON).content("{\"name\":1}"))
