/*
 * File: CreateI18nUseCaseTest.java
 * Purpose: Minimal test for create use case.
...
class CreateI18nUseCaseTest {
  @Test
  void creates() {
    I18nCommandPort cmd = new I18nCommandPort() {
      public I18n create(I18n i) { return i; }
      public I18n update(Long id, I18n i) { return null; }
      public void delete(Long id) { }
    };
    var uc = new CreateI18nUseCase(cmd);
    var created = uc.execute(I18n.of("en", List.of("en")));
    assertEquals("en", created.defaultLocale());
  }
}
